...
(* OASIS_START *)
(* DO NOT EDIT (digest: 56373c1a32bfddff35d29cd4c5da2a23) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Word2phrase"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "word2phrase";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "word2phrase_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "word2phrase_test.ml";
                      });
               Executable
                 ({
                     cs_name = "wordcount";
                   ...
                   {exec_custom = false; exec_main_is = "wordcount.ml"; });
               Executable
                 ({
                     cs_name = "learn_vocab_tri";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "learn_vocab_tri.ml"; 
                   })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "³\129\147y\017\130ÁÐ~¯ÿ¡¡zx\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
